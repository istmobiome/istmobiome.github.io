...
- Extensive experience in both marine & terrestrial field work. 

- PADI Rescue Diver certification. 

- Highly skilled analyzing DNA datasets (amplicon, genomic, & metagenomic).

- Expertise incl.  [R](https://www.r-project.org/), [R Markdown](https://rmarkdown.rstudio.com/), [Hugo](https://gohugo.io/), [Python](https://www.python.org/), CSS, HTML, [anvi'o](http://merenlab.org/software/anvio/). 
...
I study microbial diversity.  My holistic approach spans marine & terrestrial systems to better understand  how a collection of  simple organisms coalesce into  complex communities  & how the structure of these communities affect host biology, biogeochemical cycles, & ecosystem-level processes. I also want to make research more accessible & exciting, transparent & reproducible. To that end, I make & teach open-source tools to create web products that communicate science more effectievly. 
...
Web Products {data-icon=globe data-concise=true}
--------------------------------------------------------------------------------

### [Cacao Fermentation](https://istmobiome.github.io/cacao/talk.html)

Public leture about the microbiology of cacao fermentation.
...
Public leture about microbial diversity.
...
Reproducible bioinformatic workflows for reef fish microbiome project.
