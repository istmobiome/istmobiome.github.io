...
![Jarrod J. Scott](bitmap1.png){width=70%}
...
This document was made with the R package [**pagedown**](https://github.com/rstudio/pagedown) and a lot of help from the Internet. You can find the GitHub  <i class="fa fa-github"></i> repo for this cv [here](https://github.com/istmobiome/istmobiome.github.io/tree/master/jarrod-cv).
