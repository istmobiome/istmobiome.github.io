...
- Computational expertise include [anvi'o](http://merenlab.org/software/anvio/), [R](https://www.r-project.org/), [R Markdown](https://rmarkdown.rstudio.com/), [Hugo](https://gohugo.io/), [Python](https://www.python.org/). 
...
Prior Research & Professional <br/>Experience {data-icon=compass}
--------------------------------------------------------------------------------
...
::: aside
[Click here](https://wiki.santafe.edu/index.php/Complex_Systems_Summer_School_2015_(CSSS)) to access the  the proceedings for the 2015 CSSS.
:::
...
::: aside
[Click here](http://dmoserv3.bco-dmo.org/data_docs/GEOTRACES/AE1410/2014_ChfSci_Training_final_cruise_rpt.pdf) to access the final report from the 2014 UNOLS training cruise.
:::
