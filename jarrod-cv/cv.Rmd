...
- [Click here](https://istmobiome.github.io/jarrod-cv/cv.pdf) for a pdf version of this CV.
...
- Computational skills include anvi'o, R, R Markdown, Hugo, Python. 
...
::: aside
You can check out the proceedings for the 2015 CSSS course [here](https://wiki.santafe.edu/index.php/Complex_Systems_Summer_School_2015_(CSSS)).
:::
