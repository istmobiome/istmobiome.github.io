...
<div class="zoom"><a href="fish_network_big.svg" target="_blank">
      <img src="fish_network_big.svg" alt=""></div>
...
I study microbial diversity and take a  holistic approach to understand how microbes I do my best to take a holistic approach to build & see the bigger picture. My work spans marine & terrestrial ecosystems, which helps how microbes .I try to make my science  accessible & exciting, transparent & reproducible. I use & teach open-source tools to make web products that communicate science more effectievly .
...
::: aside
I teach the way I learn. Be curious, get your hands dirty, make mistakes, & explore. I'm here to help students see what's possible, not tell them what to do. 
:::
...
The source code for this cv is available [here](https://github.com/istmobiome/istmobiome.github.io/tree/master/jarrod-cv). I made it with the R package [**pagedown**](https://github.com/rstudio/pagedown) and  help from the Internet, especially this [**repo**](https://github.com/nstrayer/cv). 
