...
## <font color="#1b1b1b">Fermentation defined</font> {data-background-image="images/fermentation_general.png" data-background-size="95%" style="font-size:0em"}


## <font color="#1b1b1b">history</font> {data-background-image="images/fermentation-history.png" data-background-size="90%" style="font-size:0em"}
...
## <font color="#1b1b1b">parencchyma</font> {data-background-image="images/cotyledon.png" data-background-size="90%" style="font-size:0em"}
...
::: {style="font-size: 0.5em;color: #414141;font-family: 'Lato';font-weight: '100';text-align: left;"}
Photo on Slide XX of *Lactobacillus* entitled *Kolorierte rasterelektronenmikroskopische Aufnahmen von Lactobacillus paracasei* by Dr. Horst Neve (Max Rubner-Institut) was obtained from Wikimedia Commons licensed under [Attribution-Share Alike 3.0 Germany](https://creativecommons.org/licenses/by-sa/3.0/de/deed.en). [Original file](https://commons.wikimedia.org/wiki/File:Lactobacillus_paracasei.jpg).
:::
...
::: {style="font-size: 0.7em;font-family: 'Lato';font-weight: '100';text-align: left;"}
Below is a list of the principal publications used in this presentation, listed alphabetically by first author. Each publication contains the unique digital object identifier (DOI). 
:::
...
<em>
Many of the articles linked in this presentation sit behind pay walls. No matter what, do not enter the DOI address into <a href="https://sci-hub.tw/">sci-hub</a> to access a publication. Seriously. Don't do it. Pay the publisher ~$30 per publication and go broke trying to learn.
</em>
</p>
