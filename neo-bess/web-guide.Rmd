...
<div class = "note">
<font size="3">With a little practice the tools you learn in this course  can be used to create a range of document types, from a single .html or .pdf file, to multi-page web sites, to books, and even your **thesis or dissertation**.
</font>
</div>
...
**A note** on the format and use of this site. This site was constructed using [flexdashboard](https://rmarkdown.rstudio.com/flexdashboard/). Each page typically has two or more panels and each panel in like its own page. So depending on your screen size, you may need to scroll individual panels to see the full content. 
...
### <font size="5">Why do I have to make a webpage?</font>
...
### <font size="5">Why are we using R, RStudio, and R Markdown?</font>
...
<div class = "warning">
<font size="3">Please note. This is not an R course. At least one of us (me) is not an expert in R and teaching R is beyond the scope of the course. However, building a website through the R environment is a great point of entry to the amazing suite of resources this platform offers.
</font>
</div>
...
R is both a software language and an environment for statistical computing and graphics. At some point, you will all need to need to embrace a programming environment to analyze your data  and  summarize your findings in figures, tables, etc. R is certainly not the only way to do this; however coupled with the ability to package everything in a website, I believe this environment offers a valuable suite of tools for your scientific needs. The benefits of R are that  **a**) it is free and open source, **b**) its  capabilities are extended through user-created packages, **c**) it has a huge community of users (which means it is well supported), **d**) it is powerful and flexible.
...
Before we get to the R part we first need to take a look at the Markdown component.
