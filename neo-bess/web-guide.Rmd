...
* [Single page HTML](https://istmobiome.github.io/DIGEST/Phyloseq_workflow.html) workflow and [source code]().
...
* The class resouce website. Look in the upper right corner. 
* If anyone is interested in adding content to the *Ants for Isabella* page, please let me know. I would like to make it into something nicer that can be shared with more kids. 
