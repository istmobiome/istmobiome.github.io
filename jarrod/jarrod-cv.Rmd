...
- Bioinformatics (amplicon, genomic, & metagenomic). [anvi'o](http://merenlab.org/software/anvio/), [DADA2](https://benjjneb.github.io/dada2/), [mothur](https://mothur.org/), [R](https://www.r-project.org/), [Python](https://www.python.org/). 
...
Proceedings of the Royal Society B: Biological Sciences *In Press* <i class="ai ai-open-access"></i>
