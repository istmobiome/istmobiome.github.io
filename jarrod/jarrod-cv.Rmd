...
I study [microbial diversity](#pubs).  My approach is holistic, spanning [marine](#marine) & [terrestrial](#land) systems to understand  how simple organisms coalesce into  complex communities  & how these communities affect host biology, biogeochemical cycles, & ecosystem-level processes. I also work to make [my research](#pubs) more accessible & exciting, transparent & reproducible. I use & [teach](#teach) open-source tools to create [web products](#web) that communicate science more effectively. 
...
Recent Teaching Experience {data-icon=chalkboard-teacher #teach}
--------------------------------------------------------------------------------
### Instructor
...
::: aside
[**Click here**](https://stri-mcgill-neo.github.io/2022/) for the course tutorial site 
:::

Field sites incl. [Barro Colorado Island](https://stri.si.edu/facility/barro-colorado), [Bocas del Toro](https://stri.si.edu/facility/bocas-del-toro), [Agua Salud](https://stri.si.edu/facility/agua-salud), & [Isla Coiba](https://stri.si.edu/facility/coibita-island). 

### Instructor & Course Creator

[Web Products & Data Curation](https://stri-con.github.io/data-curation/)
...
::: aside
[**Click here**](https://stri-con.github.io/data-curation/) for the course website. 
:::


Online course about creating web-based reproducible workflows using open source software tools and platforms. The course website can be found [here](https://stri-con.github.io/data-curation/). 
...
::: aside
[**Click here**](https://istmobiome.rbind.io/workshops/bocas-del-toro-panama-2018/) for the workshop website & [**here**](https://doi.org/10.1371/journal.pbio.3000533) for the publication written by workshop participants. 
:::
...
### [R Markdowng Fielduide](https://stri-mcgill-neo.github.io/2022/)
...
### [SWELTR](https://sweltr.github.io/high-temp/)

Reproducible bioinformatic workflows for the study **S**oil **W**arming **E**xperiment in **L**owland **T**ropical **R**ainforest. 
...
### [BocasBiome](https://bocasbiome.github.io/)
...
Reproducible bioinformatic workflows for the study [*Intestinal microbes: an axis of functional diversity among large marine consumers*](https://doi.org/10.1098/rspb.2019.2367).
...
### [R Markdown Fieldguide](https://stri-mcgill-neo.github.io/2022/)  
...
### [Workshop Guide](https://istmobiome.rbind.io/workshops/workshop-2018/)
...
[ISME Communications 3, 127 (2023)](https://doi.org/10.1038/s43705-023-00333-6) 
...
[Nature Microbiology 7, 1650–1660 (2022)](https://doi.org/10.1038/s41564-022-01200-1) 

N/A

2022

Nottingham AT, **Scott JJ**, Saltonstall K,  Broders K,  Montero-Sanchez M,   Püspök J,  Bååth E,  Meir P. 

::: aside
[**Click here**](https://sweltr.github.io/high-temp/) for the project website & reproducible workflows from this paper. 
:::


### The gut microbiome variability of a butterflyfish increases on severely degraded Caribbean reefs

[Communications Biology 5, 770 (2022)](https://doi.org/10.1038/s42003-022-03679-0) <i class="ai ai-open-access"></i>
...
::: aside
[**Click here**](https://bocasbiome.github.io/) for the project website & reproducible workflows from this paper. 
:::

### Rapid ecosystem-scale consequences of acute deoxygenation on a Caribbean reef

[Nature Communications 12, 4522 (2021)](https://doi.org/10.1038/s41467-021-24777-3) <i class="ai ai-open-access"></i>
