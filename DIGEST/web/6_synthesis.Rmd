...
```{r load_2, include=FALSE, cache=TRUE}
...
<div class = "yellow">
<font size="4">Now it was time to put the pieces together and determine...What these patterns tell us about specificity? 
</font>
</div>
<p></p>
...
itol_tree <- svgPanZoom("DATA/PHYLOSEQ/FIGURES/INPUT/Figure_3_TreeA_2.svg", 
...
```{r tree_legend, echo = FALSE, message = FALSE, fig.align = "center", cache=TRUE}
itol_legend <- knitr::include_graphics("DATA/PHYLOSEQ/FIGURES/INPUT/Figure_3_Legend_A.svg")
itol_legend
```
...
```{r message = FALSE, include = FALSE, warning = FALSE, cache=TRUE}
...
```{r mantel_test_a, warning=FALSE, message = FALSE, fig.align = "center", cache=TRUE}
...
host_tree <- knitr::include_graphics("DATA/PHYLOSEQ/FIGURES/INPUT/collapse_tree.svg", 
                                     dpi = 300)
host_tree
```
