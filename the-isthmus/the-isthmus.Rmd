...
subtitle: "⚔<br/>on land & in the sea"
...
The Source Code [`r fa(name = "github", fill = "white")`](https://github.com/istmobiome/istmobiome.github.io/tree/master/the-isthmus) for the presentation is also available.  

This is an [amazing tutorial](https://arm.rbind.io/slides/xaringan.html#1) on the [xaringan](https://github.com/yihui/xaringan) package.

Press `p` to see the speaker notes where you can find more description of the slides. 
